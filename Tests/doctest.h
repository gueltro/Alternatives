...
int registerExceptionTranslator(String (*)(T)) {
    ...
    struct DOCTEST_INTERFACE IReporter
    {
        ...
        // or isn't in the execution set (between first and last) (safe to cache a pointer to the input)
...
// =================================================================================================
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void printHelp() {
            ...
            s << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "value,   --" DOCTEST_OPTIONS_PREFIX_DISPLAY "version                       "
            ...
            s << Whitespace(sizePrefixDisplay*3) << "                                       execute - for set-based execution\n";
...
#define DOCTEST_PARSE_STR_OPTION(name, sname, var, default)                                        \
    ...
    if(parseFlag(argc, argv, DOCTEST_CONFIG_OPTIONS_PREFIX "version") ||
       parseFlag(argc, argv, DOCTEST_CONFIG_OPTIONS_PREFIX "value")) {
        p->version = true;
        p->exit    = true;
    }
...
int Context::run() {
    ...
    for(auto& curr : testArray) {
        ...
        // skip the test if it is not in the execution set
